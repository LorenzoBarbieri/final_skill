...
function compareSlots(slots, correct_answer) {
  for (const slot in slots) {
    if (Object.prototype.hasOwnProperty.call(slots, slot) && slots[slot].value !== undefined) {
      if (slots[slot].value.toString().toLowerCase() === correct_answer.toString().toLowerCase()) {
        return true;
      }
    }
  }
    ...
    let speakOutput, speakOutput1 = " ", speakOutput2 = " ", speakOutput3 = " ";
            ...
            //if (attributes.counter_orientation === 7) {   attributes.answer = address.postalCode;     }
             ...
             return {speakOutput, speakOutput1, speakOutput2, speakOutput3};
                 ...
                 const speakOutput = `${attributes.score_orientation}. `+ '<amazon:emotion name="excited" intensity="high">Great! <break time="1s"/> The game is finished. Next part is about memory.</amazon:emotion>';
            ...
            handlerInput.attributesManager.setSessionAttributes(attributes); 
            speakOutput1 =' I will tell you 5 words, <break time="1s"/> try to remember them. ';
