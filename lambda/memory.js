...
function classification(handlerInput) {
    ...
    sessionAttributes.score_memory_classification = sessionAttributes.score_memory;
            ...
            handlerInput.attributesManager.setSessionAttributes(sessionAttributes);
            speakOutput = `<amazon:emotion name="excited" intensity="high">Thank you. Your score in memroy part is. ${sessionAttributes.score_memory_classification}.</amazon:emotion> `;
